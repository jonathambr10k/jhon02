...
const BotName = 'jhonBot'; 
const instagram = '
const aktif = '07:00 - 23:00';
...
const get = require('got')
	...
	if (messagesC.includes("fdp")){
		...
		if (messagesC.includes("kkkkkk")){
			...
			if (messagesC.includes("jhonkbot")){
			client.updatePresence(from, Presence.composing)
			reply("oiii")
	}
...
// recursos anime, random @minatin domina vida
          ...
          reply('Espere..')
				...
				if (!isUser) return reply(mess.only.userB)
					...
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*╭────*「 *PREMIUM USER👑* 」\n*│+ wa.me/553599138474*╰──────*「 *jonatham foda* 」*────*\n\n*_SE QUER SER UM USUÁRIO PREMIUM DO jonatham bot BOT_*\n*_Ketik #daftarvip*' })
					break
					case 'cekmod': 
